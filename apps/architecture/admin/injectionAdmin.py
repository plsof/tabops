...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='injection')
        return rs.id
...
class injectionAdmin(ImportExportModelAdmin):
    resource_class = injectionResource
