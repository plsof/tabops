...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='cossearch')
        return rs.id
...
@admin.register(cossearch)
class cossearchAdmin(ImportExportModelAdmin):
    resource_class = cossearchResource
