...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='dangj')
        return rs.id
...
@admin.register(dangj)
class dangjAdmin(ImportExportModelAdmin):
    resource_class = dangjResource
