...
class bimspanelResource(resources.ModelResource):
...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='bimspanel')
        return rs.id
...
@admin.register(bimspanel)
class bimspanelAdmin(ImportExportModelAdmin):
    resource_class = bimspanelResource
