...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='tptopic')
        return rs.id
...
@admin.register(tptopic)
class tptopicAdmin(ImportExportModelAdmin):
    resource_class = tptopicResource
