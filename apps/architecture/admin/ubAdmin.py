...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='ub')
        return rs.id
...
@admin.register(ub)
class ubAdmin(ImportExportModelAdmin):
    resource_class = ubResource
