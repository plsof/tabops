...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='lbss')
        return rs.id
...
@admin.register(lbss)
class lbssAdmin(ImportExportModelAdmin):
    resource_class = lbssResource
