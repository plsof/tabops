...
class serviceFilter(admin.SimpleListFilter):
    ...
    def bussiness_id(self):
        rs = bussiness_type.objects.get(name='unionpay')
        return rs.id
...
@admin.register(unionpay)
class unionpayAdmin(ImportExportModelAdmin):
    resource_class = unionpayResource
